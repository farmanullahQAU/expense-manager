...
firebaseLoggedInuser.value=null;
      pmHomeTabNavController.clear();
      
      Get.find<SelectProjectController>().currentProject.value=null;
      Get.find<SelectProjectController>().projectListAdmin.value=[];
      Get.find<SelectProjectController>().projectListCustomer.value=[];
      Get.find<SelectProjectController>().projectListPm.value=[];
      update();

...
class PmHomeTabNav extends GetWidget<PmHomeTabNavController> {
 final custOrPm=Get.find< AddCustomerOrpmController>() ;

  TabController _tabController;
  final selectProjectController = Get.find<SelectProjectController>();
  var usrController = Get.put(UsrController());
                        ...
                        actions: [
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                ...
                                true?Center(child: CircularProgressIndicator(),):Container(width:0.0,height:0.0)

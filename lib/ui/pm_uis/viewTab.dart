...
class ViewTab extends GetWidget {
          ...
          children: [
            InkWell(
              ...
              onTap: () {
                ...
                Get.toNamed('fetchProjectsUi');
              },
            ),
            InkWell(
              child: addCard(context, Colors.blue, 'Payment', Icons.money),
              onTap: () {
                // selectedProjCont.currentProject.value == null
            ...
            addCard(context, Colors.blue, 'Customers', Icons.person),
            InkWell(
              onTap: () {},
              child: addCard(
                context,
